      ...
      <div className="mx-auto max-w-7xl px-6 pt-16">
        <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
          ...
          <div className="flex gap-3">
            <a href="#" className="flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--theme-active)] text-[var(--theme-text-muted)] transition hover:bg-[var(--theme-hover)] hover:text-[var(--theme-text)]">
