...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[var(--theme-bg)]">
      <div className="mx-auto max-w-7xl px-6 pt-16">
        <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
          <p className="max-w-sm text-sm text-[var(--theme-text-dim)]">
            {strings.footerTagline}
          </p>
          <div className="flex gap-3">
            <a href="https://github.com/ThomasGiardina" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--theme-active)] text-[var(--theme-text-muted)] transition hover:bg-[var(--theme-hover)] hover:text-[var(--theme-text)]">
            ...
            <a href="https://www.linkedin.com/in/thomas-agustin-giardina-484a86324/" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--theme-active)] text-[var(--theme-text-muted)] transition hover:bg-[var(--theme-hover)] hover:text-[var(--theme-text)]">
      ...
      <div className="mt-2 border-t border-[var(--theme-border)] bg-[var(--theme-surface)] px-6 py-4">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 md:flex-row">
          <p className="text-xs text-[var(--theme-text-dim)]">{strings.copyright.replace("{year}", new Date().getFullYear())}</p>
