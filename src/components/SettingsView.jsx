        ...
        <div className="min-w-0 flex-1 space-y-6">
            ...
            <>
              <div className="rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-surface)] p-6">
                ...
                <div className="space-y-4">
                  ...
                  {passwordForm ? (
                    <form onSubmit={handleChangePassword} className="space-y-3 border-t border-[var(--theme-border)] pt-4">
                      <input
                        type="password"
                        value={newPassword}
          ...
          {activeSection === "acerca" && (
            <div className="rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-surface)] p-6">
              ...
              <p className="mt-4 text-sm leading-relaxed text-[var(--theme-text-secondary)]">
              ...
              <div className="mt-4 flex items-center gap-2">
                ...
                <a
                  href="https://github.com/tomigandini/Watch-Deck"
                  target="_blank"
