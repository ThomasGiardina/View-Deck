      ...
      <footer className="relative bg-[#0a0a0f]">
        <div className="mx-auto max-w-7xl px-6 pt-16 pb-0">
          <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
            ...
            <div className="flex gap-3">
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/[0.06] text-slate-400 transition hover:bg-white/10 hover:text-white">
          ...
          <div className="mt-12">
            <h2 className="bg-gradient-to-r from-indigo-400 via-violet-400 to-purple-400 bg-clip-text text-6xl font-bold tracking-tight text-transparent md:text-7xl lg:text-8xl">
              Watch Deck
            </h2>
          </div>
        </div>

        <div className="mt-12 border-t border-white/[0.06] bg-white/[0.02] px-6 py-6">
